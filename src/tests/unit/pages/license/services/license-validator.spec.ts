...
import { ContentLibService, LicenseRepository } from '@smc/pages/license/services';
...
import { LicenseModel } from '@smc/pages/license/model/license.model';
...
describe('SMC: Pages', () => {
    ...
    describe('License', () => {
        ...
        describe('Service: LicenseValidator', () => {
